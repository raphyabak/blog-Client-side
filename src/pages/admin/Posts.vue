<template>
    <div class="space-y-16 px-12 py-5">
        <button type="button" v-on:click="newPost"
        ...
        <div>
            <div v-for="post in posts" :key="post.uuid"
                class="flex items-baseline mx-auto sm:justify-between flex-wrap sm:flex-nowrap space-x-0 sm:space-x-6 space-y-3 sm:space-y-0">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        <router-link :to="{ name: 'admin.posts.edit', params: { uuid: post.uuid } }"
                            class="text-sm font-medium">Edit</router-link>
                    </div>
                    <div>
