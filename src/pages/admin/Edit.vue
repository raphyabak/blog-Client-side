<template>
    <div>
        <div v-if="post.slug" class=" w-full left-0 top-0 p-6 flex justify-between items-center space-x-6">
     ...
     <Editor v-model:modelValue="post.body" v-model:teaserValue="post.teaser" class="px-10" />   
    </div>
</template>
